    ...
    <section className="relative overflow-hidden py-20 bg-gradient-to-br from-[#eef1ff] via-white to-[#dfe3ff]">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-16">
          {/* LADO ESQUERDO — TEXTO */}
          <div className="space-y-8 animate-fade-in-up text-center md:text-right order-2 md:order-1 md:pb-10">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-lg md:ml-auto leading-relaxed animate-fade-in-up">
              Acesse consultas, telemedicina, carteirinha digital e rede credenciada diretamente pelo seu celular com praticidade e rapidez.
            </p>
            ...
            <div className="space-y-3 text-gray-700 md:ml-auto">
              {[
                ...
                <p
                  key={i}
                  className="flex items-center justify-center md:justify-end gap-2 text-base animate-fade-in-up"
                >
            ...
            {/* BOTÕES */}
            <div className="flex flex-col sm:flex-row gap-4 pt-6 justify-center md:justify-end animate-fade-in-up">
              <a
          ...
          <div className="flex justify-center md:justify-center order-1 md:order-2 animate-fade-in-up pb-10">
            <img
              src={appImg}
